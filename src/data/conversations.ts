...
export const INITIAL_MESSAGES: Message[] = [
  ...
  m("c-dewi", "rina", "Rina", "Halo kak Dewi, Paket Reguler kemarin gimana hasilnya? 😊", 28),
  ...
  // Rahmat (loyal, unread)
  m("c-rahmat", "sari", "Sari", "Pak Rahmat, order 12 kg sudah siap diambil ya 🙏", 6),
  ...
  // Maya (promising)
  m("c-maya", "c-maya", "Maya Putri", "Mbak, paket bundling Paket Cuci Lengkap ada nggak?", 100),
  m("c-maya", "rina", "Rina", "Ada kak! 10kg Paket Cuci Lengkap Rp 70.000 saja 😊", 99),
  m("c-maya", "c-maya", "Maya Putri", "Oke besok aku setor ya", 98),
  m("c-maya", "rina", "Rina", "Ditunggu kak 🙏", 97),

  // Kevin (promising)
  m("c-kevin", "c-kevin", "Kevin Pratama", "Bro, Layanan Tambahan brapa lama biasanya?", 150),
  ...
  // Iwan (resolved)
  m("c-iwan", "c-iwan", "Iwan Setiawan", "Pesanan ku udah selesai belum?", 500),
  m("c-iwan", "sari", "Sari", "Sudah kak, bisa diambil hari ini", 499),
  m("c-iwan", "c-iwan", "Iwan Setiawan", "Oke makasih", 498),

  // Nina (resolved)
  m("c-nina", "c-nina", "Nina Anggraini", "Konsultasi sudah selesai ya, makasih", 700),
